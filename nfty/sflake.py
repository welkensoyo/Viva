...
GROUP BY YEAR(c.CLAIM_PAID_DATE), MONTH(CLAIM_PAID_DATE), DATEADD(DAY, -1 - EXTRACT(DAYOFWEEK FROM CLAIM_PAID_DATE), DATE_TRUNC('DAY', CLAIM_PAID_DATE)), TO_CHAR(CLAIM_PAID_DATE,'MON')
ORDER BY 3 DESC;''',
