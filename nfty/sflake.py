...
ORDER BY 3 DESC;''',
    ...
    'collections': '''
SELECT YEAR(s.SCHEDULE_DATE) as YEAR, MONTH(CLAIM_PAID_DATE) AS MONTH, TO_CHAR(CLAIM_PAID_DATE,'MON') AS MONTH_ABBR,
...
GROUP BY YEAR(CLAIM_PAID_DATE), MONTH(CLAIM_PAID_DATE), DATEADD(DAY, -1 - EXTRACT(DAYOFWEEK FROM CLAIM_PAID_DATE), DATE_TRUNC('DAY', CLAIM_PAID_DATE)), TO_CHAR(CLAIM_PAID_DATE,'MON'),MONTH(CLAIM_PAID_DATE), YEAR(s.SCHEDULE_DATE)
ORDER BY 3 DESC;''',
