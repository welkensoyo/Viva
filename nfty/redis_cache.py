...
class RedisCache:
    ...
    def set(self, key, meta, expire=86400, nx=True):
        self.r.set(str(key), json.jc(meta), ex=expire, nx=nx)
        return True
    ...
    def append(self, key, meta, expire=86400, nx=True):
        ...
        self.r.append(key, json.jc(meta))
        return True
    ...
    def scanforncrypt(self, clienthash):
        ...
        return ncrypt.encrypt(json.jc(self.scanfor(clienthash)), clienthash)
...
class Notificator(object):
    ...
    def set(self, userhash, meta, expire=123):
        notice = self.noticeid.format(userhash)
        self.r.set(notice, json.jc(meta), expire, True)
        return
